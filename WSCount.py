...
try:
    ...
    with open("FileNotFoundError.txt", "w+") as new_file:
        new_file.write("File does not exist, please try again by placing a valid file named 'TestDocument.txt' in current directory")
    sys.exit(0)
